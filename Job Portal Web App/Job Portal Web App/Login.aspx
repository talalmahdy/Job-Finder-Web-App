<%@ Page Title="Login - EBLA" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Job_Portal_Web_App.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <tbody>
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td><a href="ForgotPassword.aspx" class="link" target="_blank">Forgot your Password?</a></td>
    </tr>
    <tr>
      <td align="right">&nbsp;</td>
      <td><a href="Sign Up.aspx" class="link">New User?</a></td>
    </tr>
  </tbody>
</table>
</td>
