<%@ Page Title="Edit Jobs - EBLA Admin" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditJobs.aspx.cs" Inherits="Job_Portal_Web_App.Admin.EditJobs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="5" cellspacing="5" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Description" runat="server" CssClass="txtbox" Rows="5" TextMode="MultiLine" Width="170px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Deadline" runat="server" CssClass="txtbox" TextMode="DateTime"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="UpdateButton" runat="server" CssClass="txtbox" Text="Update" OnClick="UpdateButton_Click" />
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 50%">&nbsp;</td>
